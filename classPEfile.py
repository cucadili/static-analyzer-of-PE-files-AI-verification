...
class pefile:
    ...
    def getImportedFunctions(self, retVal=False):
        ...
        if self.is32bit:
            ...
            struct_unpack_fmt = 'q'
            index_offset = 8
        row.append(len(self.importSymbolDict))#number dlls
        count=0
    ...
    def getExportedFunctions(self, retVal=False):
        if retVal:
            ...
            '''
        row=[]
        row.append(len(self.exportSymbolDict))
        count=0
...
#################################################################################    
    def printMSDOSHeader(self):
        row=[]
        row.append(self.msdosDict['01_magicnumber'])
        row.append(self.msdosDict['02_bytesLastPage'])
        row.append(self.msdosDict['03_pagesInFile'])
        row.append(self.msdosDict['04_numRelocs'])
        row.append(self.msdosDict['05_paragraphs'])
        row.append(self.msdosDict['06_minpara'])
        row.append(self.msdosDict['07_maxpara'])
        row.append(self.msdosDict['08_stackmod'])
        row.append(self.msdosDict['09_spregister'])
        row.append(self.msdosDict['10_chksum'])
        row.append(self.msdosDict['11_ipregister'])
        row.append(self.msdosDict['12_codemod'])
        row.append(self.msdosDict['13_offsetfirstreloc'])
        row.append(self.msdosDict['14_overlaynum'])
        row.append(self.msdosDict['15_pPEHeader'])
        #print(row)
        return row
        '''
    ...
    def printPEHeader(self):
        row=[]
        row.append(len(self.peHeader))#size pe header
        #row.append(self.peDict['01_machine'])
        row.append(self.peDict['02_numberofsections'])
        row.append(self.peDict['03_timedatestamp'])
        row.append(self.peDict['04_pSymbolTable'])
        row.append(self.peDict['05_numSymbols'])
        row.append(self.peDict['06_sizeoptheader'])
        #row.append(self.peDict['07_chars'])
        return row
        '''
    ...
    def printPEOptHeader(self):
        row=[]
        row.append(len(self.peOptionalHeader))#size PE optional header
        #row.append(self.peoptDict['01_optionalHeaderMagic'])
        row.append(self.peoptDict['02_majorlnkv'])
        row.append(self.peoptDict['03_minorlnkv'])
        row.append(self.peoptDict['04_codesize'])
        row.append(self.peoptDict['05_initsize'])
        row.append(self.peoptDict['06_uninitsize'])
        row.append(self.peoptDict['07_entrypoint'])
        row.append(self.peoptDict['08_baseofcode'])
        row.append(self.peoptDict['09_baseofdata'])
        row.append(self.peoptDict['10_imagebase'])
        row.append(self.peoptDict['11_sectionalignment'])
        row.append(self.peoptDict['12_filealignment'])
        row.append(self.peoptDict['13_majorop'])
        row.append(self.peoptDict['14_minorop'])
        row.append(self.peoptDict['15_majorimage'])
        row.append(self.peoptDict['16_minorimage'])
        row.append(self.peoptDict['17_majorsubver'])
        row.append(self.peoptDict['18_minorsubver'])
        row.append(self.peoptDict['19_win32verval'])
        row.append(self.peoptDict['20_sizeofimage'])
        row.append(self.peoptDict['21_sizeofheaders'])
        row.append(self.peoptDict['22_checksum'])
        row.append(self.peoptDict['23_subsystem'])
        #row.append(self.peoptDict['24_DllCharacteristics'])
        row.append(self.peoptDict['25_SizeOfStackReserve'])
        row.append(self.peoptDict['26_SizeOfStackCommit'])
        row.append(self.peoptDict['27_SizeOfHeapReserve'])
        row.append(self.peoptDict['28_SizeOfHeapCommit'])
        row.append(self.peoptDict['29_loaderflags'])
        row.append(self.peoptDict['30_NumberOfRvaAndSizes'])
